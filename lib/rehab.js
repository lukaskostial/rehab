...
(function() {
  ...
  module.exports = Rehab = (function() {
    ...
    Rehab.prototype.process = function(folder) {
      var files;
      files = this.getSourceFiles(folder);
      return this.processList(files, folder);
    };

    Rehab.prototype.processList = function(files, folder) {
      var depGraph, depList;
      if (!folder) {
        folder = ".";
      }
      depGraph = this.processDependencyGraph(folder, files);
      depGraph = this.normalizeFilename(folder, depGraph);
      depList = this.processDependencyList(depGraph);
      return depList.reverse();
    };

    Rehab.prototype.processDependencyGraph = function(folder, files) {
      var depGraph, f, _i, _len;
      depGraph = [];
